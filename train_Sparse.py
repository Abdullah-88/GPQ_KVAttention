...
class TransformerImageClassification(SGPQ_KVAttentionTransformer):
    def __init__(
        self,
        image_size=32,
        patch_size=4,
...
model = TransformerImageClassification().to(device)
print(model)
...
logname = "/PATH/GPQ_KVAttention/Experiments_cifar10/logs_sgpq_kva/logs_cifar10.csv"
...
path = "/PATH/GPQ_KVAttention/Experiments_cifar10/weights_sgpq_kva"
model_name = "SGPQ-KVAImageClassification_cifar10"
